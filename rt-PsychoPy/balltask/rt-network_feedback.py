...
if expInfo['feedback_on']=='Feedback':
    filename = f"data/sub-sharp2{expInfo['participant']}" + os.path.sep + 'sub-sharp2%s_ses-feedback_task-neurofeedback_run-0%s' %(expInfo['participant'],expInfo['run'])
...
with open(filename+'_roi_outputs.csv', 'a') as csvfile:
    ...
    stim_writer.writerow(['volume', 'scale_factor', 'time', 'time_plus_1.2', 'B', 'A', 'stage', 'cen_cumulative_hits', 'dmn_cumulative_hits', 'pda_outlier', 'ball_y_position', 'top_circle_y_position', 'bottom_circle_y_position'])       
...
text = visual.TextStim(win=win, ori=0, name='text', #second slide of text?
...
\n\n如果注意练习成功，中间的白色小球会向上方的黄色圆圈移动。\
\n\n反之，可能会向下方的蓝色圆圈移动。\
\n\n如果白色小球在任意圆圈内停留5秒，它会回到原处。 \
\n\n尽量让白色小球向上方的圆圈移动！\n\n按任意键继续。"

feedback_run1_text2 = "尽量不要时刻关注小球的移动情况，因为这可能干扰你注意练习的效果。\
\n\n尽量将注意力放在你自身的感官变化上。\
\n\n小球的移动情况只是你注意练习的反馈参考。\
\n\n这一轮训练会持续２分钟。\n\n按任意键继续。" 

feedback_later_runs_text = "很好! 接下来，你将继续完成2分钟的注意练习\
\n\n当屏幕上出现十字(+)时，请放松休息。\n \n 当圆圈出现，尽力让白色小球向上移动! \
\n\n这一轮训练会持续２分钟。\n\n 按任意键继续。"

#tHis is slide 1 

no_feedback_later_runs_text = "很好! 接下来，你将继续完成2分钟的注意练习。\
