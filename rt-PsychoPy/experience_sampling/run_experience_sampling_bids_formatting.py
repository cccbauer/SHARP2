...
from bids_tsv_convert_experience_sampling import convert_experiencesampling_csv_to_bids
...
with open(filename+'_events.tsv', 'a', newline="") as csvfile:
            stim_writer = csv.writer(csvfile, delimiter='\t',
                        quotechar='|', quoting=csv.QUOTE_MINIMAL)
            stim_writer.writerow(['onset', 'duration', 'trial_type', 'feedback_source_volume',
...
convert_experiencesampling_csv_to_bids(infile = f'{filename}_roi_outputs.tsv')
