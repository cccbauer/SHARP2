...
dlg = gui.DlgFromDict(dictionary=expInfo, title=expName, 
        labels = {'participant': 'Participant ID (###)', 
                  'session': 'Session (baseline/neurofeedback/followupX)',
                  'run': 'Run (1/2)', 
                  'No_of_ROIs': '# of ROIs',
...
# Setup the Window
win = visual.Window(size=(900,900), fullscr=True, screen=1, allowGUI=False, allowStencil=False,#1080, 1080
...
instructions_text = visual.TextStim(win=win, ori=0, name='instructions_text',
        ...
        \n\n接下来你会用滑动评分条回答两个关于你思绪的问题，请尽量准确回答。\
        \n\n请用左手无名指点击向左，中指点击向右滑动，然后食指确认。\
        \n\n这些问题没有标准答案，我们只需要你尽量准确地反映你的感受。\
